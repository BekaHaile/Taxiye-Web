...
export const REQUEST_CANCEL_INITIATED = "REQUEST_CANCEL_INITIATED";
export const REQUEST_CANCEL_FINISHED = "REQUEST_CANCEL_FINISHED";

export const RIDE_ARRIVED = "RIDE_ARRIVED";

export const REQUEST_LOADING_CHANGED = "REQUEST_LOADING_CHANGED";
export const REQUEST_MADE = "REQUEST_MADE";

export const RIDE_STARTED = "RIDE_STARTED";
export const RIDE_STATUS_CHANGED = "RIDE_STATUS_CHANGED";
