...
import { ContentWrapper, FlexContainer, CustomButton, HeaderContainer, CenteredForm, FormContainer, InputContainer, Title, SubTitle } from "../../elements";
            ...
            <FormContainer>
                <LeftAlignedForm>
                    ...
                    <ContentContainer>
                        ...
                        <Container>
                            <SubTitle>
                                Please remember your Taxiye Corporate app login credentials to access your corporate dashboard.
                            </SubTitle>
                        </Container>
                        <Container>
                            <CustomFlexContainer>
